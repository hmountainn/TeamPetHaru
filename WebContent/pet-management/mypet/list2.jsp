		...
		<div id="body">
			<div class="float-content">
				...
				<main id="main">
						...
						<div class="mypet-section">
							...
							<div class="btn add">
								<!-- 								<span onclick="addPopup()" href="" class="button big">반려동물
									추가하기</span> -->
								<span href="" class="button big" onclick="askPet()">반려동물
									추가하기</span>
							</div>
					...
					<div class="add-mypet-popup" id="popup-6">
						<div class="popup-content">
							<div class="close-btn" onclick="askPet()">×</div>
							<div class="confirm-box">
								<h3>반려동물 선택</h3>
								<div class="dog_cat_input">
									<img class="dogimg" src="../../images/dogimoji.png"> <img
										class="catimg" src="../../images/catimoji.png"><br>
									<td><input id="pet" type="radio" name="pet" value="강아지"
										onclick="addPopup()">강아지
									<td><input id="pet" type="radio" name="pet" value="고양이"
										onclick="addCatPopup()">고양이
								</div>
							</div>
							<!--dog-info-->
					...
					<div class="add-mypet" id="popup-7">
						<!--cat!!!!!!!!!!-->
						<div class="popup-content">
							<div class="close-btn" onclick="addCatPopup()">×</div>
							<div class="img-box">
								<input type="file" class="file-button"> <span
									class="file-trigger-button">Upload</span>
							</div>
...
<form action="reg" method="post">
								...
								<div class="dog_breed add-container">
									<label class="add-label">품종<span class="necessary">*</span></label>
									<select name="breed_id">
										<option>고양이 품종선택</option>
										<option value="11">노르웨이숲</option>
										<option value="12">러시안블루</option>
										<option value="13">먼치킨</option>
										<option value="14">믹스묘</option>
										<option value="15">뱅갈 </option>
										<option value="16">버만</option>
										<option value="17">브리티시 쇼트헤어</option>
										<option value="18">터키시 앙고라</option>
										<option value="19">페르시안</option>
										<option value="20">히말라얀</option>
									</select>
								</div>
